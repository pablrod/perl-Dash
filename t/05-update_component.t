...
sub IsStructureEqualJSON {
    ...
    is_deeply(
        $json->decode( $json->encode( $structure ) ),
...

{
    ...
    my $input_update_component = '{"output":"output-id.children","changedPropIds":["input-id.value"],"inputs":[{"id":"input-id","property":"value","value":"initial value"}]}';
...

{
    ...
    $test_app->callback(
        Output   => [
            { component_id => 'output-id', component_property => 'children' },
    ...
    my $input_update_component = '{"output":"..output-id.children...second-output-id.children..","changedPropIds":["input-id.value"],"inputs":[{"id":"input-id","property":"value","value":"initial value"}]}';
...

{
    ...
    my $input_update_component = '{"output":"output-id.children","changedPropIds":["input-id.value"],"inputs":[{"id":"input-id","property":"value","value":"initial value"}],"state":[{"id":"second-input-id","property":"value","value":"state value"}]}';
